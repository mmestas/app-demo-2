  ...
  return {
    ...
    link: function(scope, el, attrs){
      ...
      var uploadS3 = function() {
       ...
       apiSrvc.getData($rootScope.apiUrl + '/Default.aspx?remotemethodaddon=appDemo2GetPatientRecordS3Parameters&patientRecordId=' + patientRecordId + '&filename=' + filename + '&content_type=' + contentType + '&acl=public-read').then(function (resp) {
      ...
      var uploadLargeFile = function (xmlText) {
          upload({
              url: $rootScope.apiUrl + '/Default.aspx?remotemethodaddon=appDemo2SetPatientRecordS3CBCTFileResponse&RequestBinary=true',
              method: 'POST',
              data: {
