app.controller('adminDashCtrl', function ($rootScope, $scope, $state, $stateParams, $location, apiSrvc, commonFnSrvc, NgTableParams, fileUpload, $http, $timeout, $interval, $compile, Upload, upload, $filter, blockUI, ModalService, authSrvc) {
  ...
  $scope.getTags = function() {
    apiSrvc.getData($rootScope.apiUrl + '/Default.aspx?remotemethodaddon=appDemo2GetTags').then(function(response) {
  ...
  $scope.changeTagColor = function(selectedCase, selectedTag) {
    apiSrvc.getData($rootScope.apiUrl + '/Default.aspx?remotemethodaddon=appDemo2SetPatientTag&PatientID=' + selectedCase.id + '&TagID=' + selectedTag.id).then(function(response) {
  ...
  $scope.getTechnicians = function () {
      apiSrvc.getData($rootScope.apiUrl + '/Default.aspx?remotemethodaddon=appDemo2GetUsersFromRole&roleGuid={fbc16991-fd1b-43db-89c8-9c2906281eb3}').then(function (response) {
  ...
  //     apiSrvc.getData($rootScope.apiUrl + '/Default.aspx?remotemethodaddon=appDemo2SetPatientTechnician&patientId=' + caseFile.id + '&userId=' + 0)
    ...
    var caseId = caseFile.id;
      ...
      apiSrvc.getData($rootScope.apiUrl + '/Default.aspx?remotemethodaddon=appDemo2GetUserInformation').then(function (response) {
          if (response.errors.length > 0) {
              ...
              apiSrvc.getData($rootScope.apiUrl + '/Default.aspx?remotemethodaddon=appDemo2SetPatientTechnician&patientId=' + caseId + '&userId=' + techId.id)
                  .then(function (response) {
                    if(response.errors.length > 0) {
                      var modalData = {
                        modalTitle: 'Error',
  ...
  $scope.getDiagnosticians = function () {
      apiSrvc.getData($rootScope.apiUrl + '/Default.aspx?remotemethodaddon=appDemo2GetUsersFromRole&roleGuid={7496ea19-b7e4-4805-8c8e-7c22bf483cbc}&roleGuid2={35196A22-7C2C-4F91-A25C-7CD783D28CCC}').then(function (response) {
  ...
  //     apiSrvc.getData($rootScope.apiUrl + '/Default.aspx?remotemethodaddon=appDemo2SetPatientDiagnostician&patientId=' + caseFile.id + '&userId=' + 0)
  //         .then(function (response) {
  //         });
  // };
    ...
    var caseId = caseFile.id;
      ...
      apiSrvc.getData($rootScope.apiUrl + '/Default.aspx?remotemethodaddon=appDemo2GetUserInformation').then(function (response) {
          if (response.errors.length > 0) {
              ...
              apiSrvc.getData($rootScope.apiUrl + '/Default.aspx?remotemethodaddon=appDemo2SetPatientDiagnostician&patientId=' + caseId + '&userId=' + diagnosticianId.id)
                  .then(function (response) {
                    if(response.errors.length > 0) {
                      var modalData = {
                        modalTitle: 'Error',
  ...
  $scope.getFinalReviewers = function () {
      apiSrvc.getData($rootScope.apiUrl + '/Default.aspx?remotemethodaddon=appDemo2GetUsersFromRole&roleGuid={35196A22-7C2C-4F91-A25C-7CD783D28CCC}').then(function (response) {
  ...
  //     apiSrvc.getData($rootScope.apiUrl + '/Default.aspx?remotemethodaddon=appDemo2SetPatientFinalReviewer&patientId=' + caseFile.id + '&userId=' + 0)
  //         .then(function (response) {
  //         });
  // };
    ...
    var caseId = caseFile.id;
      apiSrvc.getData($rootScope.apiUrl + '/Default.aspx?remotemethodaddon=appDemo2GetUserInformation').then(function (response) {
          if (response.errors.length > 0) {
              ...
              apiSrvc.getData($rootScope.apiUrl + '/Default.aspx?remotemethodaddon=appDemo2SetPatientFinalReviewer&patientId=' + caseId + '&userId=' + finalReviewerId.id)
                  .then(function (response) {
                    if(response.errors.length > 0) {
                      var modalData = {
                        modalTitle: 'Error',
  ...
  $scope.hideCase = function (casefile) {
      apiSrvc.getData($rootScope.apiUrl + '/Default.aspx?remotemethodaddon=appDemo2GetUserInformation').then(function (response) {
          if (response.errors.length > 0) {
              ...
              var caseId = casefile.id;
              apiSrvc.getData($rootScope.apiUrl + '/Default.aspx?remotemethodaddon=appDemo2SetToHidePatientCasefile&patientId=' + caseId + '&value=' + value)
                  .then(function (response) {
                    if(response.errors.length > 0) {
                      var modalData = {
                        modalTitle: 'Error',
