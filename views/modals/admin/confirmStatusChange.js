app.controller('confirmStatusChangeModalCtrl', function($scope, $rootScope, apiSrvc, upload, patientDetails, statusObject, isProvider, close) {
  ...
  $scope.changeStatus = function () {
    apiSrvc.getData($rootScope.apiUrl + '/Default.aspx?remotemethodaddon=appDemo2SetPatientProfileStatus&PatientProfileGuid='+patientDetails.guid+'&StatusGuid='+statusObject.guid)
